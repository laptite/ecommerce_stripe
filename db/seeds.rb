...
# NON-RECURRING SINGLE PURCHASE PRODUCT
...
#   price: "4.99", 
#   sku: "GROHACK1", 
#   download_url: "https://s3-us-west-2.amazonaws.com/e-commerce-stripe/receipt.pdf",
...
copywriting_monthly = Product.create(
  ...
  details: "We'll charge you monthly for unlimited access to our mentoring team", 
  description: %{
    <p>A copywriter is a rare combination: someone with the right writing skills who can come up with clever advertising and marketing content.</p>
...
analytics_monthly = Product.create(
  ...
  details: "We'll charge you monthly for unlimited access to our mentoring team", 
  description: %{
    <p>In this series, Mattan Griffel introduces you to the concept of analytics and shares his favorite tips for getting started using analytics.</p>
    <p><strong>What You'll Learn</strong></p>
    <ul class="no-indent">
